    ...
    public class RefInitializer : CreateDatabaseIfNotExists<RefereeContext>
    {
        protected override void Seed(RefereeContext context)
        {
            ...
            var league = new List<League>
            {
                ...
                new League { Id = 10, Name = "I liga kadetek", Type = "game", Visible = true },
                new League { Id = 20, Name = "II liga kadetek", Type = "game", Visible = true },
                new League { Id = 30, Name = "I liga kadetów", Type = "game", Visible = true },
                new League { Id = 40, Name = "II liga kadetów", Type = "game", Visible = true },
                new League { Id = 50, Name = "I liga juniorek", Type = "game", Visible = true },
                new League { Id = 60, Name = "II liga juniorek", Type = "game", Visible = true },
                new League { Id = 70, Name = "I liga juniorów", Type = "game", Visible = true },
                new League { Id = 80, Name = "II liga juniorów", Type = "game", Visible = true },
                new League { Id = 90, Name = "III liga seniorów", Type = "game", Visible = true },
                new League { Id = 100, Name = "III liga seniorek", Type = "game", Visible = true },
                new League { Id = 110, Name = "IV liga seniorów", Type = "game", Visible = true },

                new League { Id = 210, Name = "II liga Mężczyzn - Grupa 1", Type = "game", Visible = true },
                new League { Id = 220, Name = "II liga Mężczyzn - Grupa 2", Type = "game", Visible = true },
                new League { Id = 230, Name = "II liga Mężczyzn - Grupa 3", Type = "game", Visible = true },
                new League { Id = 240, Name = "II liga Mężczyzn - Grupa 4", Type = "game", Visible = true },
                new League { Id = 250, Name = "II liga Kobiet - Grupa 1", Type = "game", Visible = true },
                new League { Id = 260, Name = "II liga Kobiet - Grupa 2", Type = "game", Visible = true },
                new League { Id = 270, Name = "II liga Kobiet - Grupa 3", Type = "game", Visible = true },
                new League { Id = 280, Name = "II liga Kobiet - Grupa 4", Type = "game", Visible = true },
                new League { Id = 290, Name = "I liga Kobiet", Type = "game", Visible = true },
                new League { Id = 300, Name = "I liga Mężczyzn", Type = "game", Visible = true },
                new League { Id = 310, Name = "Orlen Liga", Type = "game", Visible = true },
                new League { Id = 320, Name = "Plus Liga Mężczyzn", Type = "game", Visible = true },

                new League { Id = 400, Name = "Liga Mistrzyń CEV", Type = "game", Visible = true },
                new League { Id = 410, Name = "Liga Mistrzów CEV", Type = "game", Visible = true }, 
                new League { Id = 420, Name = "Puchar CEV Kobiet", Type = "game", Visible = true },
                new League { Id = 430, Name = "Puchar CEV Mężczyzn", Type = "game", Visible = true },
                new League { Id = 440, Name = "Challenge Cup Kobiet", Type = "game", Visible = true },
                new League { Id = 450, Name = "Challenge Cup Mężczyzn", Type = "game", Visible = true },
                
                new League { Id = 600, Name = "Liga akademicka Kobiet", Type = "game", Visible = true },
                new League { Id = 610, Name = "Liga akademicka Mężczyzn", Type = "game", Visible = true },
